...
export default function PremiumVibeZoneApp() {
  ...
  const [products, setProducts] = useState<any[]>([
    {
      id: 1,
      name: "Product 1",
      url: "https://res.cloudinary.com/dnrjvekqn/image/upload/v1750619992/images/1750619990214-img-%281%29.png",
      thumbnail:
        "https://res.cloudinary.com/dnrjvekqn/image/upload/v1750619952/images/1750619950731-504449358_17982249302834233_1417772778428948538_n.jpg",
  ...
  //       setProducts(response) // Use your real data directly
  //     } catch (err: any) {
                ...
                >
                  {isActive && (
                    <BlurView intensity={30} style={styles.activeNavBackground}>
                      <LinearGradient
                        colors={
                          [...(item.gradient as any), "transparent"] as any
                        }
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* {products?.map(renderPremiumVideoCard)} */}
      </ScrollView>
